...
| zustand | 4.4.7 | MIT |
| zwitch | 2.0.4 | MIT |
> Notice-required licenses in use: AGPL-3.0, GPL-2.0, Apache-2.0 AND LGPL-3.0-or-later. Their license texts ship inside node_modules; see the package LICENSE files for the full terms.